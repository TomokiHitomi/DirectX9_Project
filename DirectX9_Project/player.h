...
#define SKIN_ANIME_WEIGHT_PLAYER_SLOW		(0.03f)
#define SKIN_ANIME_WEIGHT_PLAYER_NORMAL		(0.05f)
#define SKIN_ANIME_WEIGHT_PLAYER_FAST		(0.1f)
#define SKIN_ANIME_WEIGHT_PLAYER_NON		(1.0f)
